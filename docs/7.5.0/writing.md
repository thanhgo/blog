...
title: Writing
layout: page
description: 'Hydejack offers a few additional features to markup your markdown. Don''t
  worry, these are merely CSS classes added via the standard `{:.my-class}` syntax,
